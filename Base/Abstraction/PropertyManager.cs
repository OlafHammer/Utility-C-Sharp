...
public static class PropertyManager
{
    ...
    public static List<string> PropertyNames(object t, params AvailableAttributes[] attributes)
    {
    ...
    public static List<T> PropertyValues<T>(object t, params AvailableAttributes[] attributes) where T : class
    {
        List<T> list = new();
    ...
    public static List<PropertyInfo> Properties(object t, params AvailableAttributes[] attributes)
    {
    ...
    public static int PropertyCount(object t, params AvailableAttributes[] attributes)
    {
        return EnumProperties(t, attributes).Count();
    }

    private static IEnumerable<PropertyInfo> EnumProperties(object t, IEnumerable<AvailableAttributes> attributes)
    {
